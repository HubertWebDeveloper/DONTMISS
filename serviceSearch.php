            ...
            <div class="column">
               <div class="container mt-0 mt-md-5">
                  <div class="row mt-0 mt-md-5">
                     <div class="col-lg-8">
                        <?php
                           $sel = mysqli_query($con, "SELECT * FROM session WHERE type='$cat_name' AND (category LIKE '%$type%' OR content LIKE '%$type%' OR title LIKE '%$type%') LIMIT $start_from,$number_per_page");
                              ...
                              <div class="container" style="margin-bottom:50px">
                                       <nav aria-label="..." style="float:right">
                                          <ul class="pagination" style="display:flex">
                                             <?php
                                                $sql_page = mysqli_query($con, "SELECT * FROM session WHERE type='$cat_name' AND (category LIKE '%$type%' OR content LIKE '%$type%' OR title LIKE '%$type%')");
                           ...
                           ?>
                              <div class="card post-box mt-5" style="text-align:center;color:red;font-size:23px">Search Results Not found...</div>
                           <?php
                           }
                        ?>     
                     </div>
